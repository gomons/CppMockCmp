/** @file
    @brief  Visitable Mock Method with 3 parameters.
            Generated with gen_visitablemethod_N.pl.

  $Id: VisitableMockMethod3.h 1492 2010-01-03 10:47:55Z ewald-arnold $
...
#ifndef MOCKPP_VisitableMockMethod3_H
#define MOCKPP_VisitableMockMethod3_H
...
/** Common stuff to set up visitable mock method expectations with 3 parameters.
  * @ingroup grp_controller
  */
template <typename R, typename P1, typename P2, typename P3>
class VisitableMockMethod3Common : public VisitableMockReturningMethodBase<R>
{
  public:
  ...
  /** Constructs the mock object.
    ...
    */
    VisitableMockMethod3Common(const String &name, VisitableMockObject *parent)
  ...
  /** Set up expectations with constraints.
    ...
    */
    void forward (const ConstraintHolder<P1> &p1, const ConstraintHolder<P2> &p2, const ConstraintHolder<P3> &p3) const
    {
  ...
  /** Perform the internals to verify a mocked method or setup expectations.
    ...
    * @param p3 mock method parameter 3
    */
    void forward_param(const P1 &p1, const P2 &p2, const P3 &p3) const
    {
      ...
      else
      {
        MOCKPP_TRY
        {
          ...
          Throwable *t;
          if (this->responseThrowables.find(t, p1, p2, p3))
             t->throw_me();
  ...
  /** Adds another response throwable.
    ...
    */
    void addResponseThrowable(Throwable *t, const P1 &p1, const P2 &p2, const P3 &p3, unsigned count = MOCKPP_UNLIMITED)
    {
      MOCKPP_ASSERT_FALSE(this->getVisitableMockObject()->isActivated());
      this->responseThrowables.add(t, p1, p2, p3, count);
    }
  ...
  /** Adds another response throwable.
    ...
    * @param count   the number of times this value shall be returned. Default is unlimited.
    */
    void addResponseThrowable(Throwable *t, const ConstraintHolder<P1> &p1, const ConstraintHolder<P2> &p2, const ConstraintHolder<P3> &p3, unsigned count = MOCKPP_UNLIMITED)
    {
      MOCKPP_ASSERT_FALSE(this->getVisitableMockObject()->isActivated());
      this->responseThrowables.add(t, p1, p2, p3, count);
    }
  ...
  private:
    ...
    mutable ResponseThrowableVector3<P1, P2, P3>   responseThrowables;
...
class VisitableMockMethod3
  : public VisitableMockMethod3Common<R, P1, P2, P3>
{
  public:
  ...
  /** Constructs the mock object.
    ...
    */
    VisitableMockMethod3(const String &name, VisitableMockObject *parent)
      : VisitableMockMethod3Common<R, P1, P2, P3>(name, parent)
  ...
  /** Actually verifies the mocked method.
    ...
    */
    ...
    {
      this->forward_param(p1, p2, p3);

      if (this->getVisitableMockObject()->isActivated() )
      {
        R ret_val;
        if (this->responseValues.find(ret_val, p1, p2, p3))
          return ret_val;
  ...
  /** Set up expectations with constraints.
    ...
    */
    void forward (const ConstraintHolder<P1> &p1, const ConstraintHolder<P2> &p2, const ConstraintHolder<P3> &p3) const
    {
       VisitableMockMethod3Common<R, P1, P2, P3>::forward(p1, p2, p3);
    }
#else
    using VisitableMockMethod3Common<R, P1, P2, P3>::forward;
#endif
  ...
  /** Adds another response value.
    ...
    */
    ...
    {
      MOCKPP_ASSERT_FALSE(this->getVisitableMockObject()->isActivated());
      this->responseValues.add(rv, p1, p2, p3, count);
    }
  ...
  private:
    ...
    mutable ResponseVector3<R, P1, P2, P3>   responseValues;
};
...
class VisitableMockMethod3<void, P1, P2, P3>
   : public VisitableMockMethod3Common<void, P1, P2, P3>
{
  public:
  ...
  /** Constructs the mock object.
    ...
    */
    VisitableMockMethod3(const String &name, VisitableMockObject *parent)
      : VisitableMockMethod3Common<void, P1, P2, P3>(name, parent)
    {
    }
  ...
  /** Set up expectations with constraints.
    ...
    */
    void forward (const ConstraintHolder<P1> &p1, const ConstraintHolder<P2> &p2, const ConstraintHolder<P3> &p3) const
    {
       VisitableMockMethod3Common<void, P1, P2, P3>::forward(p1, p2, p3);
    }
#else
    using VisitableMockMethod3Common<void, P1, P2, P3>::forward;
#endif
};
...
#endif // MOCKPP_VisitableMockMethod3_H
