/** @file
    @brief  Visitable Mock Method with 5 parameters.
            Generated with gen_visitablemethod_N.pl.

  $Id: VisitableMockMethod5.h 1492 2010-01-03 10:47:55Z ewald-arnold $
...
#ifndef MOCKPP_VisitableMockMethod5_H
#define MOCKPP_VisitableMockMethod5_H
...
class VisitableMockMethod5Common : public VisitableMockReturningMethodBase<R>
{
  public:
    ...
    void forward_param(const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5) const
    {
      ...
      else
      {
        MOCKPP_TRY
        {
          ...
          Throwable *t;
          if (this->responseThrowables.find(t, p1, p2, p3, p4, p5))
             t->throw_me();
  ...
  /** Adds another response throwable.
    ...
    */
    void addResponseThrowable(Throwable *t, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, unsigned count = MOCKPP_UNLIMITED)
    {
      ...
      this->responseThrowables.add(t, p1, p2, p3, p4, p5, count);
    }
  ...
  private:
    ...
    mutable ResponseThrowableVector5<P1, P2, P3, P4, P5>   responseThrowables;
...
class VisitableMockMethod5
  : public VisitableMockMethod5Common<R, P1, P2, P3, P4, P5>
{
  public:
  ...
  /** Constructs the mock object.
    ...
    */
    VisitableMockMethod5(const String &name, VisitableMockObject *parent)
      : VisitableMockMethod5Common<R, P1, P2, P3, P4, P5>(name, parent)
  ...
  /** Actually verifies the mocked method.
    ...
    * @param p5 mock method parameter 5
    */
    R forward(const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5) const
    {
      this->forward_param(p1, p2, p3, p4, p5);

      if (this->getVisitableMockObject()->isActivated() )
      {
        R ret_val;
        if (this->responseValues.find(ret_val, p1, p2, p3, p4, p5))
          return ret_val;
  ...
  /** Set up expectations with constraints.
    ...
    */
    void forward (const ConstraintHolder<P1> &p1, const ConstraintHolder<P2> &p2, const ConstraintHolder<P3> &p3, const ConstraintHolder<P4> &p4, const ConstraintHolder<P5> &p5) const
    {
       VisitableMockMethod5Common<R, P1, P2, P3, P4, P5>::forward(p1, p2, p3, p4, p5);
    }
#else
    using VisitableMockMethod5Common<R, P1, P2, P3, P4, P5>::forward;
#endif
  ...
  /** Adds another response value.
    ...
    */
    ...
    {
      MOCKPP_ASSERT_FALSE(this->getVisitableMockObject()->isActivated());
      this->responseValues.add(rv, p1, p2, p3, p4, p5, count);
    }
  ...
  private:
    ...
    mutable ResponseVector5<R, P1, P2, P3, P4, P5>   responseValues;
};
...
class VisitableMockMethod5<void, P1, P2, P3, P4, P5>
   : public VisitableMockMethod5Common<void, P1, P2, P3, P4, P5>
{
  public:
  ...
  /** Constructs the mock object.
    ...
    */
    VisitableMockMethod5(const String &name, VisitableMockObject *parent)
      : VisitableMockMethod5Common<void, P1, P2, P3, P4, P5>(name, parent)
    {
    }
  ...
  /** Set up expectations with constraints.
    ...
    */
    void forward (const ConstraintHolder<P1> &p1, const ConstraintHolder<P2> &p2, const ConstraintHolder<P3> &p3, const ConstraintHolder<P4> &p4, const ConstraintHolder<P5> &p5) const
    {
       VisitableMockMethod5Common<void, P1, P2, P3, P4, P5>::forward(p1, p2, p3, p4, p5);
    }
#else
    using VisitableMockMethod5Common<void, P1, P2, P3, P4, P5>::forward;
#endif
};
...
#endif // MOCKPP_VisitableMockMethod5_H
